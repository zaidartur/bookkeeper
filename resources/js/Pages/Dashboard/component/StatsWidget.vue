...
<template>
    <div class="col-span-12">
        <div class="font-semibold text-xl"><i class="pi pi-calendar"></i> Bulan Juni 2025</div>
    </div>
    <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
            <div class="flex justify-between mb-4">
                <div>
                    <span class="block text-muted-color font-medium mb-4">Maintenance</span>
            ...
            <span class="text-primary font-medium">Jumlah </span>
            <span class="text-muted-color">dari bulan ini</span>
        </div>
    </div>
    <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
    ...
    <div id="intra" class="col-span-12 lg:col-span-6 xl:col-span-3" style="cursor: pointer" @mouseover="mouseOnCard('intra')" @mouseout="mouseOutCard('intra')" @click="_detail('intra')">
        <div class="card mb-0">
            <div class="flex justify-between mb-4">
                <div>
                    <span class="block text-muted-color font-medium mb-4">Jaringan Intra</span>
                    <div class="text-surface-900 dark:text-surface-0 font-medium text-xl">
                        5 Trouble
                    </div>
                </div>
    ...
    <div id="metro" class="col-span-12 lg:col-span-6 xl:col-span-3" style="cursor: pointer" @mouseover="mouseOnCard('metro')" @mouseout="mouseOutCard('metro')" @click="_detail('metro')">
        <div class="card mb-0">
            <div class="flex justify-between mb-4">
                <div>
                    <span class="block text-muted-color font-medium mb-4">Jaringan Metro</span>
                    <div class="text-surface-900 dark:text-surface-0 font-medium text-xl">
                        No Trouble
                    </div>
                </div>
